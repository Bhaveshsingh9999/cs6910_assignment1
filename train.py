...
def forward_propogation(input,weight,bias,no_hidden_layer,output,activation_function,loss_fn):
  ...
  for i in range(no_hidden_layer):
    ...
    # for RelU it was giveing overflow to prevent that the first layer is normalize
...
def backward_propogation(activation,output,no_hidden_layer,weights,a,batch_size,activation_function,weight_decay,loss_fn,preactivation):
  ...
  gradient_weight=[]
  gradiend_bias=[]
  # depending upon the loss the gradient of the activation will change
...
def confusion_matrix(input,weight,bias,no_hidden_layer,activation_fn,loss_fn,activation_function,weight_decay):
  test_accuracy,test_loss=test_data_accuracy(x_test,weight,bias,no_hidden_layer,test_Y,activation_function,loss_fn,weight_decay)
  print(' test accuracy is ',test_accuracy,' test loss ',test_loss)
...
def main_call(x_data,y_train,epochs,learning_rate,batch_size,beta,beta1,beta2,epsillon,activation_fn,loss,no_hidden_layer,hidden_layer_size,optimizer,weight_init_fn,weight_decay):
  ...
  if(optimizer=='sgd'):
    print('sgd')
    weight,bias=batch_gradient_descent(x_data,y_train,epochs,learning_rate,batch_size,activation_fn,loss,no_hidden_layer,hidden_layer_size,weight_init_fn,weight_decay)
    if(datasetn=='fashion_mnist'):
      confusion_matrix(x_test,weight,bias,no_hidden_layer,activation_fn,loss,activation_fn,weight_decay)


  elif(optimizer=='momentum'):
    print('momentum')
    weight,bias=momentum_gradient_descent(x_data,y_train,epochs,learning_rate,batch_size,beta,activation_fn,loss,no_hidden_layer,hidden_layer_size,weight_init_fn,weight_decay)
    if(datasetn=='fashion_mnist'):
      confusion_matrix(x_test,weight,bias,no_hidden_layer,activation_fn,loss,activation_fn,weight_decay)

  elif(optimizer=='nag'):
    print('nag')
    weight,bias=nesterov_gradient_descent(x_data,y_train,epochs,learning_rate,batch_size,beta,activation_fn,loss,no_hidden_layer,hidden_layer_size,weight_init_fn,weight_decay)
    if(datasetn=='fashion_mnist'):
      confusion_matrix(x_test,weight,bias,no_hidden_layer,activation_fn,loss,activation_fn,weight_decay)

  elif(optimizer=='rmsprop'):
    print('rmsprop')
    weight,bias=rmsprop_gradient_descent(x_data,y_train,epochs,learning_rate,batch_size,beta,epsillon,activation_fn,loss,no_hidden_layer,hidden_layer_size,weight_init_fn,weight_decay)
    if(datasetn=='fashion_mnist'):
      confusion_matrix(x_test,weight,bias,no_hidden_layer,activation_fn,loss,activation_fn,weight_decay)
    ...
    print('adam')
    weight,bias=adam_gradient_descent(x_data,y_train,epochs,learning_rate,batch_size,beta1,beta2,epsillon,activation_fn,loss,no_hidden_layer,hidden_layer_size,weight_init_fn,weight_decay)
    if(datasetn=='fashion_mnist'):
      confusion_matrix(x_test,weight,bias,no_hidden_layer,activation_fn,loss,activation_fn,weight_decay)
    ...
    print('nadam')
    weight,bias=nadam_gradient_descent(x_data,y_train,epochs,learning_rate,batch_size,beta1,beta2,epsillon,activation_fn,loss,no_hidden_layer,hidden_layer_size,weight_init_fn,weight_decay)
    if(datasetn=='fashion_mnist'):
      confusion_matrix(x_test,weight,bias,no_hidden_layer,activation_fn,loss,activation_fn,weight_decay)
